...
void print_file(queue<float> q)
{
  cout << "myqueue contains: ";
  ofstream outfile;

  outfile.open("myq.txt", ios_base::app);
...
//  people_detector.setSensorPortraitOrientation(true);             // set sensor orientation to vertical
	...
	queue<float> myqueue;
        ...
        const char *path="/home/saeid/pclx.txt";
        ofstream outfilex(path);
     
        //outfilex.open("~/pclx.txt", ios_base::app);
        outfilex << "x values:"<<endl;
        const char *pathd="/home/saeid/pcld.txt";
	ofstream outfiled(pathd);

        //outfiled.open("~/pcld.txt", ios_base::app);
        outfiled << "distance values:"<<endl;
